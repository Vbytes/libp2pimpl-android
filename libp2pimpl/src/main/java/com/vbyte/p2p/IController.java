...
public interface IController {
     ...
     * @throws RuntimeException 当load/unload没有成对调用时，会抛出异常
     * @deprecated 请使用{@link com.vbyte.p2p.IController#load(ChannelInfo)}替代
     */
    void load(String channel, String resolution, OnLoadedListener listener) throws RuntimeException;
     ...
     * @deprecated 请使用{@link com.vbyte.p2p.IController#load(ChannelInfo)}替代
     */
    void load(String channel, int netState, OnLoadedListener listener) throws RuntimeException;
     ...
     * @deprecated 请使用{@link com.vbyte.p2p.IController#load(ChannelInfo)}替代
     */
    void load(String channel, String resolution, double startTime, OnLoadedListener listener) throws RuntimeException;
     ...
     * @deprecated 请使用{@link com.vbyte.p2p.IController#load(ChannelInfo)}替代
     */
    void load(String channel, String resolution, double startTime, int netState, OnLoadedListener listener) throws RuntimeException;
    ...
    void load(String channel, String resolution, double startTime, int netState,
              OnLoadedListener onLoadedListener, OnTimeoutListener onTimeoutListener) throws RuntimeException;
    ...
    class ChannelInfo {
        ...
        public static class Builder {
            ...
            public Builder onTimeoutListener(OnTimeoutListener listener) {
                channelInfo.onTimeoutListener = listener;
                return this;
            }
     ...
     */
    void load(ChannelInfo channel) throws RuntimeException;
}
